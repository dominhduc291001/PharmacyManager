...
@Component({
    selector: 'form-consent-complete-status',
    templateUrl: './form-consent-complete-status.component.html',
    styleUrls: ['./form-consent-complete-status.component.css'],
    encapsulation: ViewEncapsulation.None
})

export class ConsentCompleteStatusComponent implements OnInit {
    indexPage = 1;
    totalPage: number;
    loadingTable = false;
    ...
    ngOnInit(): void {
        ...
        this._consent.formConsentCompleteList(this.searchRq).subscribe((data: FormConsentCompleteRp) => {
